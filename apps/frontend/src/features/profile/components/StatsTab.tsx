...
const SectionCard: React.FC<{
  ...
  <div className="bg-sidebar border-2 border-foreground/15 rounded-xl p-4">
...
export const StatsTab: React.FC<{ user: UserType; allUsers: UserType[]; onRunUpdated?: () => void }> = ({ user, allUsers, onRunUpdated }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 pb-4">
      ...
      {/* Left: all stats content stacked */}
      <div className="flex-1 min-w-0 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Me card */}
          <div className="bg-sidebar border-2 border-foreground/15 rounded-xl p-5">
            ...
            <div className="grid grid-cols-3 gap-2 text-center border-t border-foreground/10 mt-2 pt-2">
              <div>
