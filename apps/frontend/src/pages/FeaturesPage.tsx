              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {currentFeatures.map((feature, index) => (
                    <div key={index} className="bg-background border border-foreground rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {workingOnFeatures.map((feature, index) => (
                    <div key={index} className="bg-background border border-foreground rounded-lg p-4">
